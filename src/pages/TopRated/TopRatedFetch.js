...
const TopRatedFetch = ({ title, fetchUrl }) => {
   ...
   useEffect(() => {
      setIsLoading(i => !i);
      requests.fetchURL(fetchUrl, setTopRated, 1);
   ...
   useEffect(() => {
      ...
      requests.fetchURL(fetchUrl, setTopRated, topRated.page + 1);

      setIsLoadingMore(false);
   }, [fetchUrl, isLoadingMore, topRated.page]);
      ...
      <section className="row p-2">
         <div className="row__container container">
            ...
            <div className="row__poster">
               ...
               {!topRated.result ||
                  (Array.isArray(topRated.result) &&
                     topRated.result.length === 0 &&
                     Array.from(Array(20), (_, i) => <Skeleton key={i} />))}
            </div>
            {topRated.page < topRated.total_pages && !isLoading && (
